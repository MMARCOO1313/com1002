const SEV_STYLE = {
  info: { bg: '#1A2E3E', border: '#3B82F6', icon: 'INFO' },
  warning: { bg: '#2E2A0F', border: '#FBBF24', icon: 'WARN' },
  critical: { bg: '#2E0F0F', border: '#EF4444', icon: 'CRIT' },
}
...
export default function AlertBanner({ alerts = [] }) {
  ...
  return (
    ...
    >
      <span style={{ fontSize: 12, fontWeight: 700, color: sev.border }}>{sev.icon}</span>
